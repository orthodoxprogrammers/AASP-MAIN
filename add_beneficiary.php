...
<body>
    <div class="container-fluid mt-4">
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <a href="beneficiary.php" class="btn btn-secondary"> <i class="bi bi-arrow-left"></i> Back</a>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="c_barangay" id="c_barangay" class="form-control">
                        ...
                        <div class="col-lg-6 vertical-divider ps-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label class="inputLabels">Barangay</label>
                                    <select name="b_barangay" id="b_barangay" class="form-control" required>
                                        <option value="">Select Barangay</option>
